defmodule GlorioCms.Cms.Helpers.SimpleS3Upload do
  @moduledoc """
  ...
  defp config do
    %{
      region: region(),
      access_key_id: Application.fetch_env!(:glorio_cms, :access_key_id),
      secret_access_key: Application.fetch_env!(:glorio_cms, :secret_access_key)
    }
  end
  ...
  def bucket do
    Application.fetch_env!(:glorio_cms, :bucket)
  end

  def region do
    Application.fetch_env!(:glorio_cms, :region)
  end
