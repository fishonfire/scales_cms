  ...
  def render(assigns) do
    ...
    <div id={@id}>
      <.focus_wrap id={"#{@id}-container"} phx-click-away="close" phx-target={@myself}>
        ...
        <div
          class={"flex mt-2 p-2 border justify-between block w-full rounded text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6 border-zinc-300 disabled:border-zinc-100 focus:border-zinc-400 #{if @disabled, do: "bg-gray-100", else: ""}"}
