defmodule ScalesCmsWeb.Plugs.Assets do
  @moduledoc """
     Plug to serve specific assets for the CMS.
  ...
  css_path = Path.join(__DIR__, "../../../dist/cms/css/app.css")
  @external_resource css_path
  @css File.read!(css_path)

  js_path = Path.join(__DIR__, "../../../dist/cms/js/app.js")
