defmodule ScalesCms.Cms.Helpers.SimpleS3Upload do
  @moduledoc """
  ...
  defp config do
    %{
      region: region(),
      access_key_id: Application.fetch_env!(:scales_cms, :access_key_id),
      secret_access_key: Application.fetch_env!(:scales_cms, :secret_access_key)
    }
  end
  ...
  def bucket do
    Application.fetch_env!(:scales_cms, :bucket)
  end

  def region do
    Application.fetch_env!(:scales_cms, :region)
  end
